...
class NavigationDeepLinkTest {
    ...
    fun `deep link URI constants and helper functions conform to myapp-navigate format`() {
        ...
        assertEquals("navigate/{categoryId}/{itemId}", SettingsNavigation.ROUTE_ITEM_DETAIL)
        assertEquals("navigate/seat/seat_lumbar", SettingsNavigation.ROUTE_SEAT_LUMBAR)
